...
const ChangeProjectInfo: React.FC<ChangeInfoProps> = ({ onChange, editableFields, project }) => {
  const [showConfirm, setShowConfirm] = useState(false);

  const hasChanges = Object.keys(editableFields).some(key => editableFields[key] !== project[key]);
