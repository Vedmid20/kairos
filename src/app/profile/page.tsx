  ...
  return (
    <div className="p-5">
      ...
      <div className="p-4 rounded-lg flex">
        <div className="ml-32 p-10 w-[30rem] bg-violet-500/50 rounded-lg">
          <div className="relative w-24 h-24 mt-4 cursor-pointer" onClick={() => fileInputRef.current?.click()}>
            <img src={preview || user.avatar} alt="Avatar"
                 className="w-24 h-24 object-cover rounded-full transition-all hover:opacity-80"/>
            <div
          ...
          <div className="gap-10 ml-3">
            <div className="flex m-auto">
              <Briefcase className="w-6 h-6 text-gray-500 my-1 mr-2"/>
          ...
          <div className="flex ml-3">
            <AtSign className="w-6 h-6 text-gray-500 my-1 mr-2" />
